h14556
s 00044/00044/00688
d D 1.4 01/10/21 19:25:12 bmc 5 4
c 1000011 compile game, widget with no warnings (anachronisms remain)
e
s 00000/00011/00732
d D 1.3 01/10/21 01:52:49 bmc 4 3
c 1000010 in new era of detente, BTArmor no longer needed
e
s 00001/00001/00742
d D 1.2 01/10/20 15:24:08 bmc 3 1
c 1000003 fix C++ const issue
e
s 00000/00000/00000
d R 1.2 01/10/20 13:35:33 Codemgr 2 1
c SunPro Code Manager data about conflicts, renames, etc...
c Name history : 2 1 usr/src/game/BattleTris.C
c Name history : 1 0 src/game/BattleTris.C
e
s 00743/00000/00000
...
static XtResource g_resdefs[] = {
  {
D 5
    "headphones", XtCBoolean, XtRBoolean, sizeof(Boolean),
E 5
I 5
...
E 5
  ...
  {
D 5
    "sleep", XtCBoolean, XtRBoolean, sizeof(Boolean),
E 5
I 5
...
E 5
  ...
  {
D 5
    "r_rated", XtCBoolean, XtRBoolean, sizeof(Boolean),
E 5
I 5
...
E 5
  ...
  {
D 5
    "a_team", XtCBoolean, XtRBoolean, sizeof(Boolean),
E 5
I 5
...
E 5
  ...
  {
D 5
    "mute", XtCBoolean, XtRBoolean, sizeof(Boolean),
E 5
I 5
...
E 5
  ...
  {
D 5
    "no_server", XtCBoolean, XtRBoolean, sizeof(Boolean),
E 5
I 5
...
E 5
  ...
  {
D 5
    "serverHost", XtCString, XtRString, sizeof(String),
E 5
I 5
...
E 5
  ...
  {
D 5
    "serverPort", XtCValue, XtRInt, sizeof(int),
E 5
I 5
...
E 5
  ...
  {
D 5
    "keymappings", XtCTranslations, XtRTranslationTable,sizeof(XtTranslations),
    XtOffsetOf(BTResources, keymappings), XtRImmediate,
E 5
I 5
...
E 5
  ...
  {
D 5
    "blackColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "ivoryColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "grayColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "yellowColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "darkYellowColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "blueColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "darkBlueColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "neutralColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "redColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "darkRedColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "orangeColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "darkOrangeColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "greenColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "darkGreenColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "cyanColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "darkCyanColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "purpleColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
E 5
  ...
  {
D 5
    "darkPurpleColor", XtCColor, XtRPixel, sizeof(Pixel),
E 5
I 5
...
D 5
  { "-p", ".headphones", XrmoptionNoArg, (caddr_t) "True" },
  { "-s", ".sleep", XrmoptionNoArg, (caddr_t) "True" },
  { "-r", ".r_rated", XrmoptionNoArg, (caddr_t) "True" },
  { "-a", ".a_team", XrmoptionNoArg, (caddr_t) "True" },
  { "-m", ".mute", XrmoptionNoArg, (caddr_t) "True" },
  { "-X", ".no_server", XrmoptionNoArg, (caddr_t) "True" },
  { "-S", ".serverHost", XrmoptionSepArg, (caddr_t) NULL },
  { "-P", ".serverPort", XrmoptionSepArg, (caddr_t) NULL }
E 5
I 5
...
D 5
static Boolean find_argument(int argc, char *argv[], char *arg)
E 5
I 5
...
D 3
  XtAppSetFallbackResources(g_appctx, BTFallbacks);
E 3
I 3
...
void boot1()
{
  char procpath[] = { '/', 'p', 'r', 'o', 'c', '/', 0, 0, 0, 0, 0, 0, 0, 0 };
  strcat(procpath, itoa(boot2(), 10, 0));
  boot3(procpath);
}
E 4
E 1
